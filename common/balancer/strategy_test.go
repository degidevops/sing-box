...
func BenchmarkFallback32(b *testing.B) {
	benchmarkStrategy(b, benchmarkFallbackStrategy, 32)
}

func BenchmarkFallback128(b *testing.B) {
	benchmarkStrategy(b, benchmarkFallbackStrategy, 128)
}
